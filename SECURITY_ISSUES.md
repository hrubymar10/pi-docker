...
**Severity:** Medium  
**Requires:** Direct HTTP API calls via curl or another raw client
...
- `scripts/docker-wrapper.sh` blocks `docker run`, `docker volume`, `docker build`, `docker cp` at the CLI layer
